...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $sql = "INSERT INTO product (product_name, product_price, product_description) VALUES ('$product_name', '$product_price', '$product_description')"; // building a string with the SQL INSERT you want to run
            ...
            if (in_array($fileType, $allowTypes)) {
                ...
                if (move_uploaded_file($_FILES["files"]["tmp_name"][$key], $targetFilePath)) {
                    ...
                    try {
                        ...
                        $sql = "INSERT INTO product_images (product_image_id, product_image_filename, product_id, product_main_image) VALUES (0, '$targetFilePath', '$last_id', '$main_file_image')"; // building a string with the SQL INSERT you want to run
